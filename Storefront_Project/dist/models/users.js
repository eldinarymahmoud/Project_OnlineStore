...
var users = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1.default.hashSync("".concat(u.password).concat(process.env.BCRPT_PASSWORD), parseInt(saltRounds));
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("unable create user (".concat(u.firstname, " + ").concat(u.lastname, "): ").concat(err_1));
    ...
    users.prototype.authenticate = function (email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var conn, sql, result, user, userInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        user = result.rows[0];
                        if (!bcrypt_1.default.compareSync("".concat(password).concat(process.env.BCRPT_PASSWORD), user.password)) return [3 /*break*/, 4];
                        return [4 /*yield*/, conn.query("SELECT id, firstname, lastname, email FROM users WHERE email=$1", [email])];
                    case 3:
                        userInfo = _a.sent();
                        conn.release();
