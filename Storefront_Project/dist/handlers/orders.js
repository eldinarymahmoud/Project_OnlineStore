...
var orderstore = new orders_1.orders();
/*************************************************************************/
// handler functions
...
var destroyOrder_products = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var deleted, error_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, orderstore.deleteOrder_products(req.params.id)];
            case 1:
                deleted = _a.sent();
                res.json(deleted);
                return [3 /*break*/, 3];
...
var addProduct = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, addedProduct, failToObtainID, failToObtainUser_ID, failToObtainOrderStatus, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderId = _req.params.id.toString();
            ...
            case 2:
                ...
                failToObtainID = addedProduct.id;
                failToObtainUser_ID = addedProduct.user_id;
                failToObtainOrderStatus = addedProduct.orderstatus;
