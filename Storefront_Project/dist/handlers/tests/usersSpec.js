...
describe("Testing API logic", function () {
    ...
    describe("Test Authenticate API", function () {
        it(" Authenticate to get token for user acess ", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        it("Fail to authenticate with wrong email", function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, req
    ...
    describe("Test CRUD API", function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        res = _b.sent();
                        expect(res.status).toBe(200);
                        _a = res.body, email = _a.email, firstname = _a.firstname, lastname = _a.lastname;
        ...
        it("should show user info", function () { return __awaiter(void 0, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, req
